		...
		<div class="container-wrap">
			...
			<div class="container-block">
				...
				<div class="container-body">
					<textarea class="form-control paste-input" placeholder="Enter a message" autofocus="1" spellcheck="false" autocomplete="off" autocorrect="off" autocapitalize="off" id="messageArea"></textarea>
				</div>
				<div class="container-footer">
					<div class="container-align-left">
						<div class="container-align-left-element">
							<input type="text" class="form-control encryption-key-input" placeholder="Encryption key" id="keyInput">
						</div>
						<div class="container-align-left-element max-views-container">
							<input type="number" class="form-control" min=0 max=20 id="maxViewsInput">
					...
					<div class="container-align-right">
						<div class="container-align-right-element">
							<input type="button" class="form-control create-paste-button" value="Save paste" id="saveButton">
						</div>
					</div>
				</div>
			</div>
